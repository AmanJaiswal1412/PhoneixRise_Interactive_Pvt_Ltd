"""
Django settings for newCms project.
...
SECRET_KEY = 'django-insecure-i^cou3y)d&6ur9e0%0wwzedup#21+r_(e4@5jj4erf!d7r@lsv'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "newCms", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'newCms.wsgi.application'
...
CMS_TEMPLATES = (
    ...
    ("portfolio-single.html", 'Case Studies Post'),
    ("services.html", 'Our Expertise'),
    ("service-single.html", 'Our Expertise Posts'),
    ("PageBanner_plugin.html", 'Banner Plugin'),
)
